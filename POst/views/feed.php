...
<div class="row">
	...
	<div class="row">
			...
			<div style="display:inline-block; background-color:green; width:100%; height:100px; margin-top:1%;"> </div>
...
<!-- end of the user signup -->
			...
			<h4 style="margin-left:5%;">Feeds:</h4>
			<?php
			$var=0;
					$query="SELECT *FROM feed ORDER BY date_ins DESC";
					...
					while($data=mysqli_fetch_array($res))
					{
						...
						?>
						<div class="well" style="margin-left:5%;width:90%;">
									
									<?php  $srh_id=$data['id'];
										$query1="SELECT u_name FROM password WHERE id='$srh_id'";
										$res1=mysqli_query($con,$query1);
										while($data1=mysqli_fetch_array($res1))
											{
												echo '<h5 style="color:blue;font-weight:bolder; font-family:arial;">'.$data1['u_name'].'</h5>';
											}
						...
						<?php
							echo $data['Feed'];
							echo '<br>'.'<a style="color:gray;">'.$data['date_ins'].'</a>';
						?>
						<br><a style="color:blue;">Like</a>
						<a style="color:blue;margin-left:5%;">Comment</a>
